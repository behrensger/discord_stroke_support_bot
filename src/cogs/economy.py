...
class Economy(commands.Cog):
    ...
    async def on_ready(self):
        print("Economy cogs loaded successfully")
    ...
    async def beg(self, ctx):
        ...
        embed = discord.Embed(title=random.choice(reactions),
                              description=f"{ctx.author.mention} {excuse} ${beg_amount}")
        ...
        try:
            ...
            if amount > user_bal["wallet"]:
                ...
                if num <= 50:
                    ...
                    embed = discord.Embed(title="You won!", description=f"You won ${amount}!",
                                          color=discord.Color.green())
                else:
                    await economy_collection.update_one({"id": ctx.author.id}, {"$inc": {"wallet": -amount}})
                    embed = discord.Embed(title="You lost!", description=f"You lost ${amount}!",
